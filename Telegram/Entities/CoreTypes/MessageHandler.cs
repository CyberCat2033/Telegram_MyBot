...
namespace Telegramchik.CoreTypes;
...
public class MessageHandler
{
    ...
    public MessageHandler(Message message)
    {
        ...
        {
            throw new TelegramExeption("You MUST reply to message");
        }
    }
    ...
    protected virtual string? GetFileId(Message message)
    {
        return message.Type switch
        {
            ...
            _ => throw new TelegramExeption("Unexpected message type"),
        };
    }
    ...
    )
    {
        ...
        Dictionary<MessageType, Func<Task>> messageHandlers = new Dictionary<
            MessageType,
            Func<Task>
        >
        {
